                    ...
                    for i, test in enumerate(tests):
                        ...
                        if test.answers != '?':
                            ...
                            if len(test.answer) <= 30:
                                ...
                                elements.append(Paragraph(f"A) {shuffled_answers[0]}  B) {shuffled_answers[1]}  C) {shuffled_answers[2]}  D) {shuffled_answers[3]}", custom_style))
                            elif len(test.answer) > 30:
                                elements.append(Spacer(1, 2))
                                elements.append(Paragraph(f"A) {shuffled_answers[0]}  C) {shuffled_answers[2]}", custom_style))
                                elements.append(Paragraph(f"B) {shuffled_answers[1]}  D) {shuffled_answers[3]}", custom_style))
