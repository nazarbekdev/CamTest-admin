...
from api.views.generate_test import GenerateTestView
from api.views.cam_test_user import CamTestUserView
from api.views.download_file import DownloadFileAPIView
from api.views.download_sheet import DownloadSheetFileAPIView
...
from api.views.check_sheet import CheckSheetView
urlpatterns = [
    ...
    path('generate-test', GenerateTestView.as_view(), name='generate_test'),  # mobile
    ...
    path('download/<str:user_name>', DownloadSheetFileAPIView.as_view(), name='download_user_file'),  # mobile
